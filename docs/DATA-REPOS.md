...
- [BASKETBALL-SOFTWARE.md](BASKETBALL-SOFTWARE.md)—commercial tracking and analytics vendors (cite, don't rehost)
- [SLOAN-ARCHIVE.md](SLOAN-ARCHIVE.md)—MIT Sloan conference paper index
